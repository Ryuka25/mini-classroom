...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/web-toolkit/fontawesome/free/5.15.3-web/css/all.css"/>
...
<body>
    ...
    <!-- Boostrap JS-->
    <script src="http://localhost/web-toolkit/bootstrap/4.6.0/dist/js/bootstrap.bundle.js"></script>
